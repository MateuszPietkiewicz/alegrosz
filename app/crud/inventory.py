...
class InventoryRepository:
    @staticmethod
    def get(self, db: Session, product_id: int, location_id: int):
        """Get inventory item by product_id and location_id"""
        return (db.query(InventoryItem).filter(
            and_ (InventoryItem.product_id == product_id,
                  InventoryItem.location_id == location_id)
        ).first())

    @staticmethod
    def get_by_product(self, db: Session, product_id: int) -> list[Row[tuple[InventoryItem, Location]]]:
        """
    ...
    @staticmethod
    def get_by_location(self, db: Session, location_id: int)-> list[Row[tuple[InventoryItem, Product]]]:
        """
    ...
    @staticmethod
    def get_low_stock_items(self, db: Session) -> list[Row[tuple[InventoryItem, Product, Location]]]:
        """
    ...
    def update_stock(self, db: Session, product_id: int, location_id: int,
                     quantity_change: int, reorder_point=None):
        """
    ...
    def set_stock(self, db: Session, product_id: int, location_id: int,
                  quantity: int, reorder_point=None):
        """
    ...
    def delete(self, db: Session, product_id: int, location_id: int) -> bool:
        ...
        inventory_item = InventoryItem.get(db, product_id, location_id)
...
investory_repository = InventoryRepository()